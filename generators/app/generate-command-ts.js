...
export default {
	...
	writing: (generator, extensionConfig) => {
		...
		if (bundler && (bundler === "webpack" || bundler === "esbuild")) {
			const bundlerPath =
				bundler === "esbuild" ? "vscode-esbuild" : "vscode-webpack";
			const bundlerFile =
				bundler === "esbuild" ? "esbuild.js" : "webpack.config.js";
			generator.fs.copy(
				generator.templatePath(bundlerPath, "vscode"),
				generator.destinationPath(".vscode"),
			);
			generator.fs.copyTpl(
				generator.templatePath(bundlerPath, "package.json"),
				generator.destinationPath("package.json"),
				extensionConfig,
			);
			generator.fs.copyTpl(
				generator.templatePath(bundlerPath, "tsconfig.json"),
				generator.destinationPath("tsconfig.json"),
				extensionConfig,
			);
			generator.fs.copyTpl(
				generator.templatePath(bundlerPath, ".vscodeignore"),
				generator.destinationPath(".vscodeignore"),
				extensionConfig,
			);
			generator.fs.copyTpl(
				generator.templatePath(bundlerPath, bundlerFile),
				generator.destinationPath(bundlerFile),
				extensionConfig,
			);
			generator.fs.copyTpl(
		...
		generator.fs.copyTpl(
			generator.templatePath("src/extension.ts"),
			generator.destinationPath("src/extension.ts"),
			extensionConfig,
		);
		generator.fs.copy(
			generator.templatePath("src/test"),
			generator.destinationPath("src/test"),
		);
		generator.fs.copy(
			generator.templatePath(".vscode-test.mjs"),
			generator.destinationPath(".vscode-test.mjs"),
		);
		generator.fs.copy(
			generator.templatePath("eslint.config.mjs"),
			generator.destinationPath("eslint.config.mjs"),
		);

		if (extensionConfig.pkgManager === "yarn") {
			generator.fs.copyTpl(
				generator.templatePath(".yarnrc"),
				generator.destinationPath(".yarnrc"),
				extensionConfig,
			);
		} else if (extensionConfig.pkgManager === "pnpm") {
			generator.fs.copyTpl(
				generator.templatePath(".npmrc-pnpm"),
