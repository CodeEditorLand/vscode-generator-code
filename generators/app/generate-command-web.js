...
export default {
	...
	writing: (generator, extensionConfig) => {
		...
		if (bundler === "esbuild") {
			generator.fs.copy(
				generator.templatePath("vscode-esbuild"),
				generator.destinationPath(".vscode"),
			);
		} else {
			generator.fs.copy(
				generator.templatePath("vscode-webpack"),
				generator.destinationPath(".vscode"),
			);
		}
		...
		generator.fs.copyTpl(
			generator.templatePath("src/web/extension.ts"),
			generator.destinationPath("src/web/extension.ts"),
			extensionConfig,
		);

		generator.fs.copy(
			generator.templatePath("src/web/test/suite/extension.test.ts"),
			generator.destinationPath("src/web/test/suite/extension.test.ts"),
		);

		if (bundler === "esbuild") {
			generator.fs.copyTpl(
				generator.templatePath("esbuild.js"),
				generator.destinationPath("esbuild.js"),
				extensionConfig,
			);
			generator.fs.copyTpl(
				generator.templatePath("esbuild-package.json"),
				generator.destinationPath("package.json"),
				extensionConfig,
			);
			generator.fs.copy(
				generator.templatePath(
					"src/web/test/suite/esbuild-mochaTestRunner.ts",
				),
			...
			generator.fs.copy(
				generator.templatePath(
					"src/web/test/suite/webpack-mochaTestRunner.ts",
				),
				generator.destinationPath("src/web/test/suite/index.ts"),
			);
		}
