...
export default {
	...
	prompting: async (generator, extensionConfig) => {
		...
		await generator
			...
			.then((strictJavaScriptAnswer) => {
				extensionConfig.checkJavaScript =
	...
	writing: (generator, extensionConfig) => {
		...
		generator.fs.copy(
			generator.templatePath("test"),
			generator.destinationPath("test"),
		);
		...
		generator.fs.copyTpl(
			generator.templatePath("extension.js"),
			generator.destinationPath("extension.js"),
			extensionConfig,
		);
		generator.fs.copyTpl(
